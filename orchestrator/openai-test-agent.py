...
# Define API endpoint - this is a local flask server running locally.
RESTAURANT_API_URL = "http://127.0.0.1:5000/book"
...
def process_booking(user_input: str):
    try:
        response = agent.run(prompt_template.format_prompt(user_prompt=user_input))
        print(response)
    except Exception as e:
        print(f"Error processing booking: {e}")

# Example prompts
user_prompt_1 = "I'm Paul, I'd like to book a table for 34 people tomorrow at 12:15."
#user_prompt_2 = "I need a dentist appointment for Jane Doe at 10 AM on February 3, 2024."

process_booking(user_prompt_1)
#process_booking(user_prompt_2)
